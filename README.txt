...
Solves the query "query.sl" in this directory. The logic-type, function header, grammar, constraints, and check-synth must be separated by double newlines, as shown by "exampleQuery.sl" in ./queries
